...
- **Based on DFD:** [02-diagrams.md](02-diagrams.md) (trust boundaries: <list>)
- **Scope:** <what's in / out>
...
- **Flow / element:** _(which DFD arrow or node)_
...
- [ ] Verify gate re-runs this model against the final DFD
