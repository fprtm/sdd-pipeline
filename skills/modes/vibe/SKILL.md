...
| Plan file | Written to `docs/sdd/plans/current.md` silently. Auto-approved. No wait. |
...
Plan is written to `docs/sdd/plans/current.md` automatically but NOT shown to user. Auto-approved. After task, archived to `docs/sdd/plans/archive/`. User can review later if curious.
