...
Docs (FSD, SDS, ERD, etc.) are generated silently into the feature's `docs/sdd/specs/{NNN}-{slug}/` folder. Not mentioned to user unless they ask. Available for later review.
