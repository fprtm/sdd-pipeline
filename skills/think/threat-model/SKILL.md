...
Write to `docs/sdd/design/{NNN}-{slug}-threats.md` using `threat-model.template.md` (bundled with this skill). SEC-xxx IDs are item-level and global (counter in `docs/sdd/traceability.md`).
