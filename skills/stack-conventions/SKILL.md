...
Illustrative examples of what real output looks like (TypeScript, Laravel, and
the same method applied to other stacks): see [`reference.md`](reference.md) —
the method above is what matters; the examples are just calibration.
